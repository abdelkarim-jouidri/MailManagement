                             ...
                             @endif
                                ...
                                <td class="align-middle text-end">
                                    <div class="d-flex px-3 py-1 justify-content-center align-items-center">
                                        ...
                                        <a  title="supprimer" href="/supprimer_courier_depart/{{$courrier_dept->id}}"  onclick="return confirm('Êtes-vous sûr de vouloir supprimer ce Courrier?')" class="text-sm btn btn-danger font-weight-bold mb-0 me-1"><i class="far fa-trash-alt " aria-hidden="true"></i></a>

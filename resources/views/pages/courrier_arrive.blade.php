                ...
                <div class="table-responsive p-0">
                    <table class="table table-striped   table-hover table-sm align-items-center mb-0">
                        ...
                        <tbody>
                            ...
                            @foreach ($courrier_arrive as $courrier_arrive )

                            @if($courrier_arrive->is_lu == 0)

                            <tr class="text-center table-row cursor-pointer  bg-info" data-href="{{ route('courrier_arrive.show', ['id' => $courrier_arrive->id]) }}">
                             @else
                             <tr class="text-center table-row cursor-pointer"  data-href="{{ route('courrier_arrive.show', ['id' => $courrier_arrive->id]) }}">
                             @endif
                                ...
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $courrier_arrive->date_arrivee }}

                                    </p>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $courrier_arrive->number }}

                                </p>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $courrier_arrive->ref_envoi }}

                                </p>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $courrier_arrive->expediteur }}

                                </p>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $courrier_arrive->nature }}

                                </p>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $courrier_arrive->objet }}

                                </p>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $courrier_arrive->mode }}

                                </p>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $courrier_arrive->date_envoie }}

                                </p>
                                </td>
                                <td>
                                    <p class="text-sm font-weight-bold mb-0">
                                        {{ $courrier_arrive->destination }}

                                </p>
                                </td>
                                <td >
                                    <a href="{{ url('/download_pdf_arrive',$courrier_arrive ->pdf_file)}}" class="t font-weight-bold mb-0">

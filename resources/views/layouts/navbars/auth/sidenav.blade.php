<aside class="sidenav bg-white navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-4 "
    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item">
                <a class="nav-link {{ Route::currentRouteName() == 'profile' ? 'active' : '' }}" href="{{ route('profile') }}">
                    ...
                    <span class="nav-link-text ms-1">{{ auth()->user()->login }}</span>
                </a>
            </li>
        ...
        {{-- courrier depart --}}
        <li class="nav-item">
            <a class="nav-link {{ str_contains(request()->url(), 'courrier-depart') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'courrier-depart']) }}">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="ni ni-email-83 text-dark text-sm opacity-10"></i>
                </div>
                <span class="nav-link-text ms-1">Courrier Depart</span>
            </a>
        </li>
        {{--  Courrier Arrivé--}}
        <li class="nav-item">
            <a class="nav-link {{ str_contains(request()->url(), 'courrier-arrive') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'courrier-arrive']) }}">
                <div class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                    <i class="ni ni-email-83 text-dark text-sm opacity-10"></i>
                </div>
